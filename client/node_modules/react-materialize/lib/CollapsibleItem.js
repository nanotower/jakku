...
var CollapsibleItem = function CollapsibleItem(_ref) {
  var className = _ref.className,
      ...
      info= _ref.info,
      btnFunction= _ref.btnFunction,
      btnDel= _ref.btnDel,
      props = _objectWithoutProperties(_ref, ["className", "eventKey", "expanded", "header", "children", "icon", "iconClassName", "node", "onSelect", "info", "btnFunction", "btnDel"]);
  ...
  }, icon, header, info), _react.default.createElement("div", {
